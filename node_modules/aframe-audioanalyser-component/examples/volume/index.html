<html>
  <head>
    <title>Volume</title>
    <meta name="description" content="Visualizing global average audio volume"></meta>
    <meta property="og:image" content="https://raw.githubusercontent.com/ngokevin/kframe/master/components/audioanalyser/examples/volume/preview.gif"></meta>
  <script src="https://aframe.io/releases/0.5.0/aframe.min.js"></script>
    <script src="../build.js"></script>
    <script src="../components/audioanalyser-volume-scale.js"></script>
    <script src="../../dist/aframe-audioanalyser-component.js 
...
"></script>
  ...
  <body>
    <a-scene antialias="true">
      <a-assets>
        <audio id="song" src="sunshine.mp3" autoplay loop></audio>
      ...
      <a-entity id="andy"
        ...
        material="color: #510710"
        position="0 0 -5.25"
      ></a-entity>
      <a-sphere id="leftEyeball" position="-1 2 -4" radius="0.5"></a-sphere>
      <a-sphere id="rightEyeball" position="1 2 -4" radius="0.5"></a-sphere>
    ...
    <!--githubcorner-->
    <a href="https://github.com/ngokevin/kframe/tree/master/components/audioanalyser/examples/volume/" class="github-corner">
